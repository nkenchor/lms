...
import { CreateAuthorDto } from '../../core/domain/dto/author.dto';
...
export class AuthorController {
    ...
    async getAllAuthors(req: Request, res: Response): Promise<void> {
      try {
          ...
          const result = await this.authorService.getAllAuthors(page, pageSize);
    ...
    async createAuthor(req: Request, res: Response): Promise<void> {
        try {
            const newAuthor = req.body as CreateAuthorDto; // Assuming body parsing middleware is used
